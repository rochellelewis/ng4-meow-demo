...
class Post implements \JsonSerializable {
	 ...
	 **/
	public function __construct(?int $newPostId, string $newPostContent, $newPostDate = null, string $newPostTitle) {
		try {
	...
	public function insert(\PDO $pdo) : void {
		...
		$query = "INSERT INTO post(postContent, postDate, postTitle) VALUES(:postContent, :postDate, :postTitle)";
	...
	public static function getPostsByPostContent(\PDO $pdo, string $postContent) : \SplFixedArray {
		...
		//create query template
		$query = "SELECT postId, postContent, postDate, postTitle FROM post WHERE postContent LIKE :postContent";
		$statement = $pdo->prepare($query);
	...
	public static function getPostsByPostDateRange (\PDO $pdo, \DateTime $postSunriseDate, \DateTime $postSunsetDate) : \SplFixedArray {
		...
		//create query template
		$query = "SELECT postId, postContent, postDate, postTitle FROM post WHERE postDate >= :postSunriseDate AND postDate <= :postSunsetDate";
		$statement = $pdo->prepare($query);
	...
	public static function getPostsByPostTitle(\PDO $pdo, string $postTitle) : \SplFixedArray {
		...
		//create query template
		$query = "SELECT postId, postContent, postDate, postTitle FROM post WHERE postTitle LIKE :postTitle";
		$statement = $pdo->prepare($query);
	...
	public static function getAllPosts(\PDO $pdo) : \SplFixedArray {
		//create query template
		$query = "SELECT postId, postContent, postDate, postTitle FROM post";
		$statement = $pdo->prepare($query);
		$statement->execute();
